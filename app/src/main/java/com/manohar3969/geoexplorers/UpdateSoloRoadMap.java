...
public class UpdateSoloRoadMap extends AppCompatActivity {
    Calendar myCalendar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_solo_road_map);
        ...
        imageViewStartDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(UpdateSoloRoadMap.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void updateSoloTrip(){
        ...
        //Toast.makeText(getBaseContext(),"Road Map Updated Successfully !!!",Toast.LENGTH_SHORT).show();

        Intent intent = new Intent(UpdateSoloRoadMap.this, ViewSoloRoadMap.class);
