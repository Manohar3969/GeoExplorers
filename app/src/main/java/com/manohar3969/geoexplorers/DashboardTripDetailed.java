...
public class DashboardTripDetailed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_trip_detailed);
    ...
    public void deleteGroupTripRoadMap(View view){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DashboardTripDetailed.this);
