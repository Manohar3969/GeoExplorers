...
public class SearchTrips extends AppCompatActivity {
    ...
    AdapterSearchTrip adapterSearchTrip;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists())
                {
                    ...
                    adapterSearchTrip = new AdapterSearchTrip(getBaseContext(),groupTripRoadMapList);
                    recyclerViewViewGroupRoadMapList.setAdapter(adapterSearchTrip);
                }
                else {
